...
-- Animation configs (Snappy, high-speed transitions)
hl.animation({ leaf = "windows", enabled = true, speed = 2, bezier = "md3_decel", style = "popin 80%" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 2, bezier = "md3_decel", style = "popin 80%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1.5, bezier = "md3_accel", style = "popin 80%" })
...
hl.animation({ leaf = "workspaces", enabled = true, speed = 2.5, bezier = "menu_decel", style = "slide" })
